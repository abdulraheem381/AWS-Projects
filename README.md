...
| [Event-Driven Facial Analysis](./06-event-driven-facial-analysis) | Manual and slow facial detection workflows               | S3, Lambda, Rekognition, DynamoDB, IAM, CloudWatch                                                                                                                                        | Real-time, automated face detection with metadata storage              |
